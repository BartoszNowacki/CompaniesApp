...
/// Provides a default implementation for instantiate() method
/// for a view controller. The view controller is required to provide
/// `storyboardName` and `viewControllerIdentifier` static strings.
/// View controller MUST be marked with `final` keyword for this to work
